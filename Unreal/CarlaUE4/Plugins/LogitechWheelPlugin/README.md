...
Remove directory `.git`, `LogitechWheelPlugin\Logitech\lib\Win32`, `LogitechWheelPlugin\Doc`  from [previous repository](https://github.com/HARPLab/LogitechWheelPlugin) .
