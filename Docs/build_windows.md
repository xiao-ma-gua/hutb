...
>1. Open the `UE4.sln` file inside the source folder with Visual Studio 2022 (or 2019).
...
- Commands should be executed via the __x64 Native Tools Command Prompt for VS 2022__ or __x64 Native Tools Command Prompt for VS 2019__ . Open this by clicking the `Windows` key and searching for `x64`.
